...
// Lógica para insertar un nuevo ingreso
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Consulta para insertar el ingreso sin especificar el folio
    $sql = "INSERT INTO ingreso (categoria, cantidad_dinero, descripcion, cuenta, fecha) VALUES (:categoria, :cantidad_dinero, :descripcion, :cuenta, :fecha)";
    ...
    if ($stmt->execute()) {
        echo "<script>alert('Ingreso registrado con éxito'); window.location.href='ingresos_gestion.php';</script>";
    } else {
...
<body>
    <div class="container mt-4">
        <h1 class="text-center">Registrar Nuevo Ingreso</h1>
