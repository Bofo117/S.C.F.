...
// Consulta para obtener datos de la tabla 'gasto'
$sql = "SELECT * FROM gasto WHERE uid = 12345";
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse justify-content-center" id="navbarNav">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item"><a class="nav-link" href="../html/ingresos_gestion.php">Ingresos</a></li>
                        <li class="nav-item"><a class="nav-link active" href="../html/gastos_gestion.php">Gastos</a></li>
